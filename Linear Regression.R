#descriptive analysis - nature of data, mean, median and mode,
#diagnostic analytics - correlation between variable
#predictive analyis - predicting the relationship between various variable
#prescriptive analysis -modelling for future
#simple linear regression - one dependent variable
#multiple linear regression - multiple dependent variables
#rsquare - how much variation of y is explained by x
# Regression Analysis

data(women)
women
str(women)
cov(women$height, women$weight) #covariance tells the direction of relationship between ;
#69 : which show positive relationship between height and weight
cor(women$height, women$weight) #correlation; tells the strength of relationship
